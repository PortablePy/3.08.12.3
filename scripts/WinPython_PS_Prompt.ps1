...
if (-not ($env:WINPYDIR -eq [System.IO.Path]::GetFullPath( $env:WINPYDIRBASE+"\pypy3.8-v7.3.9-win64")) ) {


$env:WINPYDIR = $env:WINPYDIRBASE+"\pypy3.8-v7.3.9-win64"
# 2019-08-25 pyjulia needs absolutely a variable PYTHON=%WINPYDIR%python.exe
$env:PYTHON = "%WINPYDIR%\python.exe"


$env:WINPYVER = '3.8.12.3PyPy'
